...
registry.register(
    PromptTemplate(
        ...
        system=(
            ...
            "- sources\n"
            "- tasks\n"
            "Set plan_id to a short identifier like 'PLAN-001' (or 'Not determined' if unknown). "
            "Populate role as 'Planner' and task as a concise framing of the planning assignment before enumerating tasks. "
            "Summarize cross-functional insights in findings, list any global constraints or assumptions, and ensure next_steps and metrics are explicit.\n"
...
registry.register(
    PromptTemplate(
        ...
        system=(
            ...
            "Do not include objects or empty dictionaries in `sources`; invalid entries will be ignored.\n"
            "Example:\n"
            '{"role": "QA", "task": "<TASK_TITLE>", "summary": "Initial smoke tests passed", "findings": "", "defects": [], "coverage": "", "risks": [], "next_steps": [], "sources": ["https://example.com/test-plan"]}\n'
            "Incorrect Example:\n"
