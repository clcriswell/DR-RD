...
PATENT_APIS_ENABLED = _flag("PATENT_APIS_ENABLED")
REGULATORY_APIS_ENABLED = _flag("REGULATORY_APIS_ENABLED")
COMPLIANCE_ENABLED = _flag("COMPLIANCE_ENABLED")
KB_ENABLED = _flag("KB_ENABLED") or os.getenv("KB_ENABLED", "true").lower() == "true"
